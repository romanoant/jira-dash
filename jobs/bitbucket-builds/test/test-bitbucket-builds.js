...
var pipelines_builds_SUT = require('../pipelines-builds');

var mockedConfig, mockedDependencies;

describe ('pipelines-builds test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      pipelines_builds_SUT.onRun(config, mockedDependencies, function(err, data){
