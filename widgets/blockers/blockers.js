    ...
    onData: function (el, data) {
        ...
        if (data.blockers.length > 0) {
            data.blockers.forEach(function(blocker) {
                var listItem = $("<li/>").append($("<img alt = '" + blocker.assigneeName + "' title='" + blocker.assigneeName + "' class='avatar' src='http://www.gravatar.com/avatar/" + md5(blocker.assigneeEmail) + "'/>"));
